...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_1] = LAYOUT_ansi_89(
        KC_MUTE,    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_F10,   KC_F11,   KC_F12,   MC_SCRSHT,          MC_LOCK,
        ...
        MC_5,       KC_LCTL,  KC_LWIN,            _______,  KC_BSPC,  KC_DEL,           LT_SPC,             _______,                                   KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [LAYER_4] = LAYOUT_ansi_89(
        ...
        MC_5,       KC_LCTL,  KC_LWIN,            KC_LALT,  KC_BSPC,  KC_DEL,           LT_SPC,             KC_RALT,                                   KC_LEFT,  KC_DOWN,  KC_RGHT),
};

#if defined(ENCODER_ENABLE) && defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [LAYER_1] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [LAYER_2]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU) },
    [LAYER_3] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [LAYER_4]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU) }
};
